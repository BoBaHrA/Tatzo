...
const styles = StyleSheet.create({
  ...
  headerAvatarLetter: { color: colors.backgroundDeep, fontSize: 17, fontWeight: '900' },
  ...
  imageAttachmentButton: { borderRadius: radius.small, overflow: 'hidden' },
  ...
  fileAttachment: {
    ...
    backgroundColor: 'rgba(0, 10, 18, 0.42)',
    padding: spacing.sm,
  },
