...
const styles = StyleSheet.create({
  ...
  backTint: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,11,19,.18)' },
  ...
  imageLoader: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', backgroundColor: '#10242b' },
